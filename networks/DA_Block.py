...
class DA_Block(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv5a = nn.Sequential(DepthWiseConv2d(in_channels, inter_channels*2, 3, padding=1),
                                    nn.ReLU())
        ...
        self.conv8 = nn.Sequential(nn.Dropout2d(0.05, False), nn.Conv2d(inter_channels, in_channels, 1),
                                   nn.ReLU())
...
if __name__ == '__main__':
    input_1 = torch.randn(1, 640, 128, 128)  # B C H W
    print(input_1.size())
    block = DA_Block(640)
